class CompartmentBuilder {
    ...
    String buildCompartmentModel(double cellVolumePercentage, int depth){
        ...
        //sb.append("\n");
        if(SpeciesBuilder.not_assigned > 0) sb.append(indent.concat("    parameter BioChem.Units.AmountOfSubstance init[".concat(String.valueOf(SpeciesBuilder.not_assigned).concat("];\n\n"))));
